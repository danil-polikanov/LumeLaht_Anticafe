      ...
      <div className="container py-5">
        <div className="row g-4">
          ...
          <div className="col-lg-3 col-md-6">
            <div className={`${styles.section} h-100`}>
              <div className={`${styles.header} d-flex align-items-center mb-3`}>
                <div className={`${styles.iconBox} ${styles.addressIcon} me-3`}>
              ...
              <div className={styles.content}>
                <div className="d-flex align-items-center mb-2">
                  <i className={`fas fa-map-marker-alt me-2 ${styles.icon}`}></i>
                  <span>Pikk tn 36, Old Tallinn</span>
                </div>
                <div className="d-flex align-items-center">
                  <i className={`fas fa-city me-2 ${styles.icon}`}></i>
          ...
          <div className="col-lg-3 col-md-6">
            <div className={`${styles.section} h-100`}>
              <div className={`${styles.header} d-flex align-items-center mb-3`}>
                <div className={`${styles.iconBox} ${styles.contactIcon} me-3`}>
                  <BsPhone size={24} />
                </div>
              ...
              <div className={styles.content}>
                ...
                >
                  <i className={`fas fa-phone me-2 ${styles.icon}`}></i>
                ...
                >
                  <i className={`fas fa-envelope me-2 ${styles.icon}`}></i>
          ...
          <div className="col-lg-3 col-md-6">
            <div className={`${styles.section} h-100`}>
              <div className={`${styles.header} d-flex align-items-center mb-3`}>
                <div className={`${styles.iconBox} ${styles.timeIcon} me-3`}>
                  <LiaClockSolid size={24} />
                </div>
                <h3 className={styles.sectionTitle}>Working hours</h3>
              </div>
              <div className={styles.content}>
                <div className={`${styles.timeSlot} d-flex justify-content-between mb-2`}>
                  <span>Mon-Sat:</span>
                  <span className={styles.timeValue}>11:00 - 23:00</span>
                </div>
                <div className={`${styles.timeSlot} d-flex justify-content-between`}>
                  <span>Sunday:</span>
                  <span className={styles.timeValue}>11:00 - 21:00</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-md-6">
            <div className={`${styles.section} h-100`}>
              <div className={`${styles.header} d-flex align-items-center mb-3`}>
                <div className={`${styles.iconBox} ${styles.socialIcon} me-3`}>
                  ...
                  {iconsMenu.map((icon, index) => {
                    ...
                    return (
                      <a
                        ...
                        className={`${styles.socialLink} ${styles[icon.label.toLowerCase()]}`}
                      >
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="d-flex align-items-center">
                ...
                <span className={styles.footerText}>Made with love</span>
              </div>
            </div>
